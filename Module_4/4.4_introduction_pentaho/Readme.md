...
- Произведена загрузка данных из репозитория
- Выполнена обработка полученных данных
- Выполнена загрузка в локально развернутую базу на `PostgreSQL` 

Для этого созданы 2 JOB и 3 трансформации. Настроено обновление по расписанию через утилиту _crone_
